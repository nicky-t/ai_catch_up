...
> 最終更新: 2026-08-23（「今日の現場ネタ」セクションを追加）
...
| 1日の分量 | 読了 10〜15分：ニュース 5〜10 件 × 3〜4 行 ＋ 現場ネタ 0〜2 件 ＋ 学習記事 1 本 ＋ 講座ネタ 1 個 |
...
- **日次ダイジェスト**：「今日の3行」→ ニュースカード（重要度バッジ：重要／注目／参考、カテゴリチップ、3〜4行要約、講師目線ブロック［重要・注目のみ］、出典・関連リンク）→ 今日の現場ネタ（すぐ試せる使い方 0〜2 件：できること・試し方・注意＋人気の根拠）→ 今日の学習カード → 今日の講座ネタ
